...
#include "core/libraries/ssl/ssl.h"
...
void RegisterLib(Core::Loader::SymbolsResolver* sym) {
    ...
    LIB_FUNCTION("he6CvWiX3iM", "libSceSsl", 1, "libSceSsl", 1, 1,
    ...
    LIB_FUNCTION("BQIv6mcPFRM", "libSceSsl", 1, "libSceSsl", 1, 1,
    ...
    LIB_FUNCTION("BQah1z-QS-w", "libSceSsl", 1, "libSceSsl", 1, 1,
    ...
    LIB_FUNCTION("UO2a3+5CCCs", "libSceSsl", 1, "libSceSsl", 1, 1,
