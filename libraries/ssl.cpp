...
void RegisterlibSceSsl(Core::Loader::SymbolsResolver* sym) {
    LIB_FUNCTION("Pgt0gg14ewU", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_allocCertDistinguishedName);
    LIB_FUNCTION("wJ5jCpkCv-c", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_certDistinguishedNameCompare);
    LIB_FUNCTION("Vc2tb-mWu78", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_convertKeyBlobToPKCS8Key);
    ...
    LIB_FUNCTION("jb6LuBv9weg", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_convertPKCS8KeyToKeyBlob);
    LIB_FUNCTION("ExsvtKwhWoM", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_convertProtectedPKCS8KeyToKeyBlob);
    ...
    LIB_FUNCTION("4HzS6Vkd-uU", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_extractAllCertDistinguishedName);
    ...
    LIB_FUNCTION("64t1HKepy1Q", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_freeCertDistinguishedName);
    LIB_FUNCTION("d7AAqdK2IDo", "libSceSsl", 1, "libSceSsl", 1, 1, CA_MGMT_freeCertDistinguishedNameOnStack);
    ...
    LIB_FUNCTION("sDUV9VsqJD8", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_checkCertificateIssuerSerialNumber);
    ...
    LIB_FUNCTION("2FPKT8OxHxo", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_extractAllDistinguishedNames);
    ...
    LIB_FUNCTION("nxcdqUGDgW8", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_extractDistinguishedNamesFromName);
    ...
    LIB_FUNCTION("CATkBsr20tY", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_getCertificateIssuerSerialNumber);
    LIB_FUNCTION("JpnKObUJsxQ", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_getCertificateIssuerSerialNumber2);
    ...
    LIB_FUNCTION("w2lGr-89zLc", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_setKeyFromSubjectPublicKeyInfo);
    LIB_FUNCTION("OeGeb9Njons", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_setKeyFromSubjectPublicKeyInfoCert);
    ...
    LIB_FUNCTION("xdxuhUkYalI", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_STORE_addIdentityWithCertificateChain);
    ...
    LIB_FUNCTION("4aXDehFZLDA", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_STORE_findIdentityByTypeFirst);
    LIB_FUNCTION("K-g87UhrYQ8", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_STORE_findIdentityByTypeNext);
    LIB_FUNCTION("ULOVCAVPJE4", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_STORE_findIdentityCertChainFirst);
    ...
    LIB_FUNCTION("j6Wk8AtmVQM", "libSceSsl", 1, "libSceSsl", 1, 1, CERT_validateCertificateWithConf);
    ...
    LIB_FUNCTION("w1+L-27nYas", "libSceSsl", 1, "libSceSsl", 1, 1, sceSslDisableOptionInternalInsecure);
