...
#include "core/libraries/nptus/nptus.h"
...
void RegisterLib(Core::Loader::SymbolsResolver* sym) {
    ...
    LIB_FUNCTION("6-+Yqc-NppQ", "libSceNpTus", 1, "libSceNpTus",
    ...
    LIB_FUNCTION("LUwvy0MOSqw", "libSceNpTus", 1, "libSceNpTus",
                 sceNpTusGetFriendsDataStatusAsync);
    ...
    LIB_FUNCTION("bcPB2rnhQqo", "libSceNpTus", 1, "libSceNpTus",
                 sceNpTusGetMultiSlotVariableAsync);
    ...
    LIB_FUNCTION("uFxVYJEkcmc", "libSceNpTus", 1, "libSceNpTus",
                 sceNpTusGetMultiSlotVariableVUser);
    ...
    LIB_FUNCTION("YRje5yEXS0U", "libSceNpTus", 1, "libSceNpTus",
                 sceNpTusGetMultiUserVariableAsync);
    ...
    LIB_FUNCTION("zB0vaHTzA6g", "libSceNpTus", 1, "libSceNpTus",
                 sceNpTusGetMultiUserVariableVUser);
    ...
    LIB_FUNCTION("5J9GGMludxY", "libSceNpTus", 1, "libSceNpTus",
                 sceNpTusSetMultiSlotVariableAsync);
    LIB_FUNCTION("1Cz0hTJFyh4", "libSceNpTus", 1, "libSceNpTus",
