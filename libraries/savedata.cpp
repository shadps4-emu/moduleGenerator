...
void RegisterLib(Core::Loader::SymbolsResolver* sym) {
    ...
    LIB_FUNCTION("kbIIP9aXK9A", "libSceSaveData", 1, "libSceSaveData",
    ...
    LIB_FUNCTION("5yHFvMwZX2o", "libSceSaveData", 1, "libSceSaveData",
    ...
    LIB_FUNCTION("SN7rTPHS+Cg", "libSceSaveData", 1, "libSceSaveData",
    ...
    LIB_FUNCTION("VwadwBBBJ80", "libSceSaveData", 1, "libSceSaveData",
